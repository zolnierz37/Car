...
<body>
	<%	
		String date = request.getParameter("date"); // w nawiasie wpisana jest nazwa inputa z Instruktor_lekcje_1.jsp
	...
	<div>
		...
		<div class="content">
			<div class="content-in-up">
				<h1 class="content-tittle">Generator zaświadczeń</h1>
				<hr>
			</div>
			<div class="content-in-down">
				...
				%> 
				<form action="Administrator_zaswiadczenia_1.jsp" enctype="multipart/form-data">
					...
					<input type="submit" name="edit" class="dodaj2" value="Generuj">
				</form>
			</div>
		</div>
		<div class="footer">
