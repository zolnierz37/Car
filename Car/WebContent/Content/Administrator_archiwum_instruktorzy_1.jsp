	...
	<div>
		...
		<div class="content">
			<div class="content-in-up">
				<h1 class="content-tittle">Archiwum instruktora <%=resultSet.getString("NAME")%></h1>
				<%
					}
				%>
				<hr>
			...
			<div class="content-in-down-table">
				<table class="tabela-kursanci">
					<tr>
				  	...
				  	<%
						connection = DriverManager.getConnection(url, user, pass);
						statement = connection.createStatement();
						String sql2 = "SELECT * FROM LESSONS INNER JOIN USERS ON LESSONS.STUDENT_ID = USERS.USER_ID WHERE (INSTRUCTOR_ID = " + student + ") AND (ARCHIVES = 'Tak') ORDER BY DATE";
				...
				<form action="Administrator_archiwum_instruktorzy_0.jsp">
