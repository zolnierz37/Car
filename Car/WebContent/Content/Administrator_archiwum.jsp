	...
	<div>
		...
		<div class="content">
			...
			<div class="content-in-down">
				<div class="content-in-down-in-chose">
					<form action="Administrator_archiwum_kursanci_0.jsp" enctype="multipart/form-data">
						<input type="submit" name="edit" class="chose" value="Kursanci">
					</form>
					<form action="Administrator_archiwum_instruktorzy_0.jsp" enctype="multipart/form-data">
						<input type="submit" name="edit" class="chose" value="Instruktorzy">
					</form>
				</div>
			</div>
		</div>
