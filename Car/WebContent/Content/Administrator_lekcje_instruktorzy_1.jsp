	...
	<div>
		...
		<div class="content">
			<div class="content-in-up">
				<h1 class="content-tittle">Spis lekcji instruktora <%=resultSet.getString("NAME")%></h1>
				<%
					}
				%>	
				<hr>
			...
			<div class="content-in-down-table">
				<table class="tabela-kursanci">
					<tr>
				  	...
				  	<%
						...
						statement = connection.createStatement();
						//String sql = "SELECT * FROM LESSONS WHERE INSTRUCTOR_ID = " + userId + " ORDER BY DATE";
						String sql2 = "SELECT * FROM LESSONS INNER JOIN USERS ON LESSONS.STUDENT_ID = USERS.USER_ID WHERE (INSTRUCTOR_ID =" + student + ") AND (ARCHIVES = 'Nie') ORDER BY DATE";
					...
					%>
				  	<tr>
						...
						<td class="wartosci">
							<form action="Administrator_instruktorzy_sms.jsp">
				...
				<form action="Administrator_lekcje_instruktorzy_0.jsp">
