	...
	<div>
		...
		<div class="content">
			<div class="content-in-up">
				<h1 class="content-tittle">Edycja danych kursanta</h1>
				<hr>
			</div>
			<div class="content-in-down">
				...
				<form action="Administrator_kursanci_edytuj_2.jsp" enctype="multipart/form-data">
				...
				<form action="Administrator_kursanci.jsp">
