...
<body>
	<%
		String id = request.getParameter("id"); // w nawiasie wpisana jest nazwa inputa/selecta z Kursant_lekcje_2.jsp
		...
		String sql = "INSERT INTO LESSONS(LESSON_ID, INSTRUCTOR_ID, STUDENT_ID, DATE, LESSON_TYPE, LESSON_NAME, HOUR_START, HOUR_END, ARCHIVES, AUTHOR) VALUES(default, '"+instructor+"' , '"+id+"', '"+date+"', '"+lesson_type+"', '"+lesson_name+"', '"+hour_start+"', '"+hour_end+"', 'Nie', '"+id+"')";
		statement.executeUpdate(sql);
		
		response.sendRedirect("Kursant_lekcje_0.jsp");
	%>
</body>
</html>