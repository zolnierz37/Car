		...
		<div class="content">
			...
			<div class="content-in-down">
				<div class="content-in-down-in-left">
					<label class="label-1">Wybierz instruktora: </label>
				</div>
				<%
				...
				%> 
				<form action="Administrator_lekcje_instruktorzy_1.jsp" enctype="multipart/form-data">
				...
				<form action="Administrator_lekcje.jsp">
