...
<body>
	<%
		String id = request.getParameter("id"); // w nawiasie wpisana jest nazwa inputa z Instruktor_profil_eydcja_1.jsp
		...
		response.sendRedirect("Instruktor_profil_edycja_1.jsp");
	%>
</body>
</html>