		...
		<div class="content">
			<div class="content-in-up">
				...
				<form action="Kursant_lekcje_1.jsp">
					<input type="submit" name="add" class="dodaj1" value="Zapisz się">
				</form>	
				<hr>
			</div>
				...
				<table class="tabela-kursanci">
					<tr>
				  	...
				  	<%
						...
						//String sql = "SELECT * FROM LESSONS WHERE STUDENT_ID = " + userId + " ORDER BY DATE";
						String sql = "SELECT * FROM LESSONS INNER JOIN USERS ON LESSONS.INSTRUCTOR_ID = USERS.USER_ID WHERE (STUDENT_ID =" + userId + ") AND (ARCHIVES = 'Nie') ORDER BY DATE";
