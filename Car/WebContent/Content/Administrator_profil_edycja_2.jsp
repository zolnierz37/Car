...
<body>
	<%
		String id = request.getParameter("id"); // w nawiasie wpisana jest nazwa inputa z Administrator_profil_eydcja_1.jsp
		...
		response.sendRedirect("Administrator_profil_edycja_1.jsp");
	%>
</body>
</html>