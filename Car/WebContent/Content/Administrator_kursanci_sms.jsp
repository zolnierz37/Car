...
<body>
	<%
		...
		String sql = "SELECT * FROM LESSONS INNER JOIN USERS ON LESSONS.STUDENT_ID = USERS.USER_ID WHERE LESSON_ID =" + lesson_id;
		...
		String tresc = "Witaj "+user_name+". Dnia "+date+" o godzinie "+hour_start+" odbędą się zajęcia "+lesson_type+" z " +lesson_name+ ". Do zobaczenia! Szkola jazdy.";	//tresc smsa
		...
		rd.close();
		response.sendRedirect("Administrator_lekcje_kursanci_0.jsp");
		%>			
</body>
</html>