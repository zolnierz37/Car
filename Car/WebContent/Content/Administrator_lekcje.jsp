		...
		<div class="content">
			...
			<div class="content-in-down">
				<div class="content-in-down-in-chose">
					<form action="Administrator_lekcje_kursanci_0.jsp" enctype="multipart/form-data">
						<input type="submit" name="edit" class="chose" value="Kursanci">
					</form>
					<form action="Administrator_lekcje_instruktorzy_0.jsp" enctype="multipart/form-data">
